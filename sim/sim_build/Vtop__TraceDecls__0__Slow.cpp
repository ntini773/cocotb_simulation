...
void Vtop___024root__traceDeclTypesSub0(VerilatedFst* tracep) {
    ...
    }
    {
        ...
        const char* __VenumItemValues[]
        = {"0", "1", "10", "11", "100", "101"};
        tracep->declDTypeEnum(5, "ibex_pkg::pc_sel_e", 6, 3, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        const char* __VenumItemValues[]
        = {"0", "1", "10", "11"};
        tracep->declDTypeEnum(6, "ibex_pkg::exc_pc_sel_e", 4, 2, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        = {"0", "1", "10", "11", "100", "101", "110", 
                                ...
                                "111101", "111110", 
                                "111111", "1000000"};
        tracep->declDTypeEnum(7, "ibex_pkg::alu_op_e", 65, 7, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
    ...
    }
    {
        ...
        tracep->declDTypeEnum(10, "ibex_pkg::csr_num_e", 145, 12, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
    ...
    }
    {
        ...
        const char* __VenumItemValues[]
        = {"0", "100", "1111"};
        tracep->declDTypeEnum(14, "ibex_pkg::x_debug_ver_e", 3, 4, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        const char* __VenumItemValues[]
        = {"0", "1", "10", "11", "100", "101", "110"};
        tracep->declDTypeEnum(15, "ibex_multdiv_fast.md_fsm_e", 7, 3, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        = {"ALBL", "ALBH", "AHBL", "AHBH"};
        const char* __VenumItemValues[]
        = {"0", "1", "10", "11"};
        tracep->declDTypeEnum(16, "ibex_multdiv_fast.mult_fsm_e", 4, 2, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        = {"RF_WD_EX", "RF_WD_CSR"};
        const char* __VenumItemValues[]
        = {"0", "1"};
        tracep->declDTypeEnum(17, "ibex_pkg::rf_wd_sel_e", 2, 1, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        const char* __VenumItemValues[]
        = {"0", "1", "10", "11"};
        tracep->declDTypeEnum(18, "ibex_pkg::op_a_sel_e", 4, 2, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        = {"OP_B_REG_B", "OP_B_IMM"};
        const char* __VenumItemValues[]
        = {"0", "1"};
        tracep->declDTypeEnum(19, "ibex_pkg::op_b_sel_e", 2, 1, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        const char* __VenumItemValues[]
        = {"0", "1", "10", "11", "100", "101", "110"};
        tracep->declDTypeEnum(20, "ibex_pkg::imm_b_sel_e", 7, 3, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        = {"IMM_A_Z", "IMM_A_ZERO"};
        const char* __VenumItemValues[]
        = {"0", "1"};
        tracep->declDTypeEnum(21, "ibex_pkg::imm_a_sel_e", 2, 1, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        const char* __VenumItemValues[]
        = {"0", "1"};
        tracep->declDTypeEnum(22, "ibex_id_stage.id_fsm_e", 2, 1, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        = {"0", "1", "10", "11", "100", "101", "110", 
                                "111", "1000", "1001"};
        tracep->declDTypeEnum(23, "ibex_pkg::ctrl_fsm_e", 10, 4, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        = {"NMI_INT_CAUSE_ECC"};
        const char* __VenumItemValues[]
        = {"0"};
        tracep->declDTypeEnum(24, "ibex_pkg::nmi_int_cause_e", 1, 5, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        = {"11", "1111", "10011", "10111", "100011", 
                                ...
                                "1100011", "1100111", 
                                "1101111", "1110011"};
        tracep->declDTypeEnum(25, "ibex_pkg::opcode_e", 11, 7, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
